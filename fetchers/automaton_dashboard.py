...
<main>
  ...
  <div class="nav-row">
    ...
    <a href="/trade/signals-audit?engine=automaton">Signals audit</a>
  </div>
...
async function predictaScanNow() {{
  try {{
    ...
    predictaToast('Scan started in the background — this can take a few minutes. Reloading now; refresh again shortly to see results.');
    setTimeout(function() {{ location.reload(); }}, 1500);
